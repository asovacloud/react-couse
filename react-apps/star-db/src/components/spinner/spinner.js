    ...
    return (
        <div className="spinner">
            ...
            >
                <style>
                    {
                        ".prefix__ldio-m4zorss5hqr-st0{opacity:.8;fill:none;stroke-width:.4811;stroke-miterlimit:10}.prefix__ldio-m4zorss5hqr-st2{opacity:.8}.prefix__ldio-m4zorss5hqr-st4{fill:none;stroke-width:.4694;stroke-miterlimit:10}"
                    }
                </style>
                <g opacity={0.5}>
                    <path
                        stroke="#799b79"
                        className="prefix__ldio-m4zorss5hqr-st0"
                ...
                <g transform="rotate(252.823 53.064 52)">
                    <path
                        fill="#2accfc"
                ...
                <g
                    className="prefix__ldio-m4zorss5hqr-st2"
                    transform="rotate(214.354 53.064 52)"
                >
                    <path
                        fill="#2accfc"
                ...
                <g
                    className="prefix__ldio-m4zorss5hqr-st2"
                    transform="rotate(71.661 53.064 52)"
                >
                    <path
                        fill="#2accfc"
                ...
                <g transform="rotate(214.354 53.064 52)">
                    <path
                        fill="#2accfc"
                ...
                <g transform="rotate(107.177 53.064 52)">
                    <path
                        fill="#2accfc"
                ...
                <path
                    stroke="#39ff39"
                    className="prefix__ldio-m4zorss5hqr-st4"
                    d="M7 86h17v7H7z"
                />
                <g>
                    <path
